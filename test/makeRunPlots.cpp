...
void CreateRunPlots( const std::vector<std::vector<std::string> >& files, bool ntuple=true, std::string output_dir="plots/", bool simulation=false)
{
  ...
  hnhits_vs_run->Sumw2();
  TH1D* hnhits_vs_time = new TH1D( "hnhits_vs_time", "Number of hits per 5 minutes", 68400, 64300, 70000 );
  ...
  TH1D* hnhitsN100M_vs_time = new TH1D( "hnhitsN100M_vs_time", "Number of hits per 5 minutes", 68400, 64300, 70000 );
  ...
  TH1D* hnhitsN100H_vs_time = new TH1D( "hnhitsN100H_vs_time", "Number of hits per 5 minutes", 68400, 64300, 70000 );
  ...
  TH1D* hnhitsN20_vs_time = new TH1D( "hnhitsN20_vs_time", "Number of hits per 5 minutes", 68400, 64300, 70000 );
  ...
  TH1D* hnhitsESUMH_vs_time = new TH1D( "hnhitsESUMH_vs_time", "Number of hits per 5 minutes", 68400, 64300, 70000 );
  ...
  TH1D* htotalQ_vs_time = new TH1D( "htotalQ_vs_time", "Total charge per 5 minutes", 68400, 64300, 70000 );
  ...
  TH1D* hNEvents_vs_time = new TH1D( "hNEvents_vs_rtime", "Number of events per 5 minutes",68400,64300,70000 );
  ...
  TH1D* hNCleanEvents_vs_time = new TH1D( "hNCleanEvents_vs_time", "Number of clean events per 5 minutes",68400,64300,70000   );
  ...
  TH1D* hFracCleanEvents_vs_time = new TH1D( "hFracCleanEvents_vs_time", "Fraction of clean events per 5 minutes",68400,64300,70000  );
  ...
  TH1D* hNEventsNHit15_vs_time = new TH1D( "hNEventsNHit15_vs_rtime", "Number of events per 5 minutes",68400,64300,70000 );
  ...
  TH1D* hNCleanEventsNHit15_vs_time = new TH1D( "hNCleanEventsNHit15_vs_time", "Number of clean events per 5 minutes",68400,64300,70000   );
  ...
  TH1D* hFracCleanEventsNHit15_vs_time = new TH1D( "hFracCleanEventsNHit15_vs_time", "Fraction of clean events per 5 minutes",68400,64300,70000  );
  ...
  for(unsigned i=0; i<files.size(); ++i){
    ...
    TH2D herrresy = plot_map["errresy"].Get2DHist(); 
    TH2D herrposz = plot_map["errposz"].Get2DHist(); 
    TH2D herrresz = plot_map["errresz"].Get2DHist(); 
    TH2D herrxresR = plot_map["errxresR"].Get2DHist(); 
    TH2D herryresR = plot_map["erryresR"].Get2DHist(); 
    TH2D herrzresR = plot_map["errzresR"].Get2DHist(); 
    ...
    TH2D herrresygoodfit = plot_map["errresygoodfit"].Get2DHist(); 
    TH2D herrposzgoodfit = plot_map["errposzgoodfit"].Get2DHist(); 
    TH2D herrreszgoodfit = plot_map["errreszgoodfit"].Get2DHist(); 
    TH2D herrxresRgoodfit = plot_map["errxresRgoodfit"].Get2DHist(); 
    TH2D herryresRgoodfit = plot_map["erryresRgoodfit"].Get2DHist(); 
    TH2D herrzresRgoodfit = plot_map["errzresRgoodfit"].Get2DHist(); 
            ...
            if((dataclean && compatibility_cut) || simulation) {
              ...
              if(fit_valid){
                ...
                if(simulation) {
                    ...
                    herrresz.Fill(fabs(posz-mcposz),poszPosError);
                ...
                if(itr>0.55){
                  ...
                  if(simulation) {
                      ...
                      herrreszgoodfit.Fill(fabs(posz-mcposz),poszPosError);
                  ...
                  if( rvertex.ContainsPosition() && rvertex.ValidPosition() ) {
                    ...
                    if(rvertex.ValidPositivePositionError()) {
                      ...
                      if(simulation){
                        ...
                        herrresy.Fill(fabs(rvertex.GetPosition().Y() - part1.GetPosition().Y()), rvertex.GetPositivePositionError().y());
                        herrresz.Fill(fabs(rvertex.GetPosition().Z() - part1.GetPosition().Z()), rvertex.GetPositivePositionError().z());
                    ...
                    if(rEV.GetClassifierResult("ITR:waterFitter").GetClassification("ITR") > 0.55){  
                        ...
                        if(rvertex.ValidPositivePositionError()) {
                          ...
                          if(simulation){
                            ...
                            herrresygoodfit.Fill(fabs(rvertex.GetPosition().Y() - part1.GetPosition().Y()), rvertex.GetPositivePositionError().y());
                            herrreszgoodfit.Fill(fabs(rvertex.GetPosition().Z() - part1.GetPosition().Z()), rvertex.GetPositivePositionError().z());
    ...
    plot_map["errxresR"].Set2DHist(herrxresR);
    plot_map["erryresR"].Set2DHist(herryresR);
    plot_map["errzresR"].Set2DHist(herrzresR);
    ...
    plot_map["errxresRgoodfit"].Set2DHist(herrxresRgoodfit);
    plot_map["erryresRgoodfit"].Set2DHist(herryresRgoodfit);
    plot_map["errzresRgoodfit"].Set2DHist(herrzresRgoodfit);
