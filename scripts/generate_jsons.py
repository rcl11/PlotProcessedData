...
nice_labels = {
    ...
    'energy': 'energy',
    'errposx': 'x err vs x',
    'errresx': 'x resolution vs x',
    'errposy': 'y err vs y',
    'errresy': 'y resolution vs y',
    'errposz': 'z err vs z',
    'errresz': 'z resolution vs z',
    'errxresR': 'x resolution vs R',
    'erryresR': 'y resolution vs R',
    'errzresR': 'z resolution vs R',
    'resR': 'R resolution',
    'resx': 'x resolution',
    'resy': 'y resolution',
    'resz': 'z resolution',
    'restime': 'time resolution',
